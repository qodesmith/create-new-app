...
export default function Email({
  ...
  return (
    <Html>
      <Head />
      <Preview>Confirm account deletion for {appName}</Preview>
      <Body
        style={{
          margin: 0,
          padding: 0,
      ...
      >
        ...
        >
          ...
          <Section style={{marginBottom: '16px'}}>
            ...
            >
              We received a request to delete your {appName} account. This
              action is permanent and all your data will be removed. Click the
          ...
          <Section style={{marginBottom: '16px'}}>
            ...
            >
              This link will expire shortly. If you did not request account
              deletion, please ignore this email and your account will remain
              unchanged.
            </Text>
          </Section>
