...
export default function Email({verificationUrl}: SignUpVerificationEmailProps) {
      ...
      >
        ...
        >
          ...
          <Section style={{marginBottom: '16px'}}>
            ...
            >
              Thanks for signing up for {appName}! Click the button below to
          ...
          <Section style={{marginBottom: '16px'}}>
            ...
            >
              This link will expire shortly. If you did not create an account,
